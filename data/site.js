...
window.SITE = {
  ...
  levels: [
    ...
    },
    {
      ...
      "objectives": [
        "히스토그램·박스플롯으로 대여건수 분포의 치우침과 퍼짐을 설명할 수 있다.",
        "산점도로 기온·강수량·요일에 따른 대여건수의 모습을 비교하고 한글 제목·축 이름·단위·범례를 갖춘 그래프를 만들 수 있다.",
        "변수의 유형과 질문에 맞는 그래프를 고르고 축 범위·색·크기가 해석에 미치는 영향을 설명할 수 있다."
      ],
      "compressible": false
    },
    {
      ...
      "objectives": [
        "상관계수의 부호와 크기를 산점도와 연결하고 대여건수·기온·강수량의 관계를 비교할 수 있다.",
        "제3의 요인과 반례를 살펴보며 상관관계만으로 인과관계를 확정할 수 없는 이유를 설명할 수 있다.",
        "회귀 모델의 입력·예측값·실제 값과 오차를 구별하고 좋은 직선을 고를 기준이 필요함을 설명할 수 있다."
      ],
      "compressible": true
    },
    {
